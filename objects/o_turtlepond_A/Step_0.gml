...
if spawntimer<=0 and !instance_exists(smallobject)
{mode="spawn" spawntimer=spawntimermax}
...
if mode="spawn"
{
if sprite_index!=sprite_spawn
{sprite_index=sprite_spawn}



if floor(image_index)>=25 and once=0
{once=1 audio_play_sound(so_spawnturtle,0,0)}
